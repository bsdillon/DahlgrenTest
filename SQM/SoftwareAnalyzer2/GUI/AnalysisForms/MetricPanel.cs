...
namespace SoftwareAnalyzer2.GUI.AnaylsisForms
{
    public partial class MetricPanel : UserControl, IProjectUser
    {
        ...
        private void criticalCsvCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                criticalCsvPaths.Clear();
            }
            criticalFilePathTextBox.Clear();
            criticalBrowseButton.Visible = !criticalBrowseButton.Visible;
            criticalFilePathTextBox.Visible = !criticalFilePathTextBox.Visible;
        ...
        private void criticalBrowseButton_Click(object sender, EventArgs e)
        {
            ...
            if (criticalCsvPaths == null && openFileDialog1.FileNames != null)
            {
                //init csvPaths list
                criticalCsvPaths = new List<string>();
            }
            if (criticalCsvPaths != null && openFileDialog1.FileNames != null)
            {
