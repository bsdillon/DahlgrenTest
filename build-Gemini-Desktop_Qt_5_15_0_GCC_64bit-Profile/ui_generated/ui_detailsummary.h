...
public:
    ...
    void setupUi(QWidget *IssueSummary)
    {
        if (IssueSummary->objectName().isEmpty())
            IssueSummary->setObjectName(QString::fromUtf8("IssueSummary"));
        ...
        button_expandWidget->setObjectName(QString::fromUtf8("button_expandWidget"));
        ...
        frame_contents->setObjectName(QString::fromUtf8("frame_contents"));
        ...
        layout_treeControlButtons->setObjectName(QString::fromUtf8("layout_treeControlButtons"));
        layout_treeControlButtons->setContentsMargins(0, 4, -1, 4);
        button_expandTree = new QPushButton(frame_buttons);
        button_expandTree->setObjectName(QString::fromUtf8("button_expandTree"));
        ...
        button_collapseTree->setObjectName(QString::fromUtf8("button_collapseTree"));
    ...
    {
        IssueSummary->setWindowTitle(QCoreApplication::translate("IssueSummary", "Form", nullptr));
        button_expandWidget->setText(QCoreApplication::translate("IssueSummary", "+", nullptr));
        topicLabel->setText(QCoreApplication::translate("IssueSummary", "<Detailed Topic Name>", nullptr));
        arrivalLabel->setText(QCoreApplication::translate("IssueSummary", "<Delivery time>", nullptr));
        button_expandTree->setText(QCoreApplication::translate("IssueSummary", "Expand Contents", nullptr));
        button_collapseTree->setText(QCoreApplication::translate("IssueSummary", "Collapse Contents", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->headerItem();
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("IssueSummary", "Message Contents", nullptr));
    } // retranslateUi
