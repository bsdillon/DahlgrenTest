...
#include <memory>
#include "../../GEMINI/include/qtgui/toggleswitch.h"
...
QT_MOC_LITERAL(1, 13, 12), // "switchedLeft"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 6), // "offset"
QT_MOC_LITERAL(4, 34, 5) // "brush"

    },
    "ToggleSwitch\0switchedLeft\0\0offset\0"
    "brush"
};
...
void ToggleSwitch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchedLeft((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToggleSwitch::switchedLeft)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ToggleSwitch::switchedLeft(bool _t1)
{
