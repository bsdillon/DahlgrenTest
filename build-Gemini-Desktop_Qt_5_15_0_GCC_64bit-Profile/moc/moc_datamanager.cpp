...
#include <memory>
#include "../../GEMINI/include/datamanager.h"
...
QT_MOC_LITERAL(3, 29, 10), // "PLAMessage"
QT_MOC_LITERAL(4, 40, 17), // "clearListenerData"
QT_MOC_LITERAL(5, 58, 12), // "dataReceived"
QT_MOC_LITERAL(6, 71, 9), // "clearData"
QT_MOC_LITERAL(7, 81, 12), // "loadDataFrom"
QT_MOC_LITERAL(8, 94, 8) // "fileName"

    },
    "DataManager\0messageReceived\0\0PLAMessage\0"
    "clearListenerData\0dataReceived\0clearData\0"
    "loadDataFrom\0fileName"
};
...
void DataManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->messageReceived((*reinterpret_cast< const PLAMessage(*)>(_a[1]))); break;
        case 1: _t->clearListenerData(); break;
        ...
        {
            using _t = void (DataManager::*)(const PLAMessage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::messageReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::clearListenerData)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DataManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataManager::dataReceived)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void DataManager::messageReceived(const PLAMessage & _t1)
{
...
// SIGNAL 1
void DataManager::clearListenerData()
{
