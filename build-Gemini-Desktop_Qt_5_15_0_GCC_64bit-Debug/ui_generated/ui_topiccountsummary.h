...
public:
    ...
    void setupUi(QWidget *TopicCountSummary)
    {
        if (TopicCountSummary->objectName().isEmpty())
            TopicCountSummary->setObjectName(QString::fromUtf8("TopicCountSummary"));
        ...
        lastArrival->setObjectName(QString::fromUtf8("lastArrival"));
    ...
    {
        TopicCountSummary->setWindowTitle(QCoreApplication::translate("TopicCountSummary", "Form", nullptr));
        topicLabel->setText(QCoreApplication::translate("TopicCountSummary", "topicLabel", nullptr));
        issueLabel->setText(QCoreApplication::translate("TopicCountSummary", "count", nullptr));
        lastArrival->setText(QCoreApplication::translate("TopicCountSummary", "lastArrival", nullptr));
        intervalLabel->setText(QCoreApplication::translate("TopicCountSummary", "intervalLabel", nullptr));
    } // retranslateUi
