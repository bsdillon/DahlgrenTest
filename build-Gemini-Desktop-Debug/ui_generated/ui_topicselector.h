...
public:
    ...
    void setupUi(QWidget *TopicSelector)
    {
        if (TopicSelector->objectName().isEmpty())
            TopicSelector->setObjectName(QStringLiteral("TopicSelector"));
        ...
        pushButton_2_saveTopics->setObjectName(QStringLiteral("pushButton_2_saveTopics"));
        ...
        pushButton_loadTopics->setObjectName(QStringLiteral("pushButton_loadTopics"));
        ...
        TopicListAll->setObjectName(QStringLiteral("TopicListAll"));
        ...
        allSelect_allTopics->setObjectName(QStringLiteral("allSelect_allTopics"));
        ...
        noneSelect_allTopics->setObjectName(QStringLiteral("noneSelect_allTopics"));
        ...
        lineEdit_filter_allTopics->setObjectName(QStringLiteral("lineEdit_filter_allTopics"));
        ...
        pushButton_selectTopics->setObjectName(QStringLiteral("pushButton_selectTopics"));
        ...
        pushButton_deselectTopics->setObjectName(QStringLiteral("pushButton_deselectTopics"));
        ...
        TopicListSelected->setObjectName(QStringLiteral("TopicListSelected"));
        ...
        allSelect_selectedTopics->setObjectName(QStringLiteral("allSelect_selectedTopics"));
        ...
        noneSelect_selectedTopics->setObjectName(QStringLiteral("noneSelect_selectedTopics"));
        ...
        lineEdit_filter_selectedTopics->setObjectName(QStringLiteral("lineEdit_filter_selectedTopics"));
    ...
    {
        TopicSelector->setWindowTitle(QApplication::translate("TopicSelector", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("TopicSelector", "Select topics to follow", Q_NULLPTR));
        pushButton_2_saveTopics->setText(QApplication::translate("TopicSelector", "Save Current Topic List", Q_NULLPTR));
        pushButton_loadTopics->setText(QApplication::translate("TopicSelector", "Load Topic List", Q_NULLPTR));
        allSelect_allTopics->setText(QApplication::translate("TopicSelector", "All", Q_NULLPTR));
        noneSelect_allTopics->setText(QApplication::translate("TopicSelector", "None", Q_NULLPTR));
        pushButton_selectTopics->setText(QApplication::translate("TopicSelector", ">", Q_NULLPTR));
        pushButton_deselectTopics->setText(QApplication::translate("TopicSelector", "<", Q_NULLPTR));
        allSelect_selectedTopics->setText(QApplication::translate("TopicSelector", "All", Q_NULLPTR));
        noneSelect_selectedTopics->setText(QApplication::translate("TopicSelector", "None", Q_NULLPTR));
    } // retranslateUi
