...
namespace SoftwareAnalyzer2.Structure.Node
{
    ...
    public interface IModifiable : INavigable
    {
        ...
        //TODO consider that this probably belongs in ANTLRTool instead of ASTree
        ...
        /// <summary>
        /// Takes in the code but retains the line and character range starts
        /// </summary>
        /// <param name="codeSnippet"></param>
        void ReplaceCode(string codeSnippet);
